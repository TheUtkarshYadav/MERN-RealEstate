...
export default function Listing() {
    ...
    return (
        <main>
            {loading &&
                <p className='text-center my-7 text-2xl text-blue-800 font-serif'>Loading...</p>
            }

            {error &&
                <p className='text-center my-7 text-2xl text-red-600 font-serif'>Something went Wrong!</p>
            }
